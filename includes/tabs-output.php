<?php
/**
 * Render settings page tabs, form and save button.
 */
	...
	<div id="tabs" class="azrcrv-ui-tabs">
		<ul class="azrcrv-ui-tabs-nav azrcrv-ui-widget-header" role="tablist">
			<li class="azrcrv-ui-state-default azrcrv-ui-state-active" aria-controls="tab-panel-settings" aria-labelledby="tab-settings" aria-selected="true" aria-expanded="true" role="tab">
				<?php // phpcs:ignore. ?>
				<a id="tab-settings" class="azrcrv-ui-tabs-anchor" href="#tab-panel-settings"><?php echo esc_html( $tab_settings_label ); ?></a>
			</li>
			<li class="azrcrv-ui-state-default" aria-controls="tab-panel-htpasswd" aria-labelledby="tab-htpasswd" aria-selected="false" aria-expanded="false" role="tab">
				<?php // phpcs:ignore. ?>
				<a id="tab-htpasswd" class="azrcrv-ui-tabs-anchor" href="#tab-panel-htpasswd"><?php echo esc_html( $tab_htpasswd_label ); ?></a>
			</li>
			<li class="azrcrv-ui-state-default" aria-controls="tab-panel-instructions" aria-labelledby="tab-instructions" aria-selected="false" aria-expanded="false" role="tab">
				<?php // phpcs:ignore. ?>
				<a id="tab-instructions" class="azrcrv-ui-tabs-anchor" href="#tab-panel-instructions"><?php echo esc_html( $tab_instructions_label ); ?></a>
			</li>
			<li class="azrcrv-ui-state-default" aria-controls="tab-panel-plugins" aria-labelledby="tab-plugins" aria-selected="false" aria-expanded="false" role="tab">
				<?php // phpcs:ignore. ?>
				<a id="tab-plugins" class="azrcrv-ui-tabs-anchor" href="#tab-panel-plugins"><?php echo esc_html( $tab_plugins_label ); ?></a>
			</li>
		</ul>
		...
		<div id="tab-panel-htpasswd" class="azrcrv-ui-tabs-scroll azrcrv-ui-tabs-hidden" role="tabpanel" aria-hidden="true">
			<fieldset>
				<legend class="screen-reader-text"><?php echo esc_html( $tab_htpasswd_label ); ?></legend>
				<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
				<?php echo $tab_htpasswd; ?>
			</fieldset>
		</div>

		<div id="tab-panel-instructions" class="azrcrv-ui-tabs-scroll azrcrv-ui-tabs-hidden" role="tabpanel" aria-hidden="true">
			<fieldset>
				<legend class="screen-reader-text"><?php echo esc_html( $tab_instructions_label ); ?></legend>
				<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
				<?php echo $tab_instructions; ?>
			</fieldset>
		</div>

		<div id="tab-panel-plugins" class="azrcrv-ui-tabs-scroll azrcrv-ui-tabs-hidden" role="tabpanel" aria-hidden="true">
			<fieldset>
				<legend class="screen-reader-text"><?php echo esc_html( $tab_plugins_label ); ?></legend>
				<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
				<?php echo $tab_plugins; ?>
			</fieldset>
		</div>

	</div>

	<input type="submit" name="btn_save" value="<?php esc_attr_e( 'Save Settings', 'azrcrv-spg' ); ?>" class="button-primary" />
...
<div class='azrcrv-donate'>
	<?php
		printf( esc_html__( 'Support %s', 'azrcrv-spg' ), esc_html( DEVELOPER_NAME ) );
	?>
